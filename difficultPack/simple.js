...
question[1] = new Question("../audio/shapeofyou.mp3","Ed Sheeran - Shape of You","OneRepublic - Counting Stars","Passenger - Let Her Go");
question[2] = new Question("../audio/seeyouagain.mp3","Wiz Khalifa - See You Again","Ed Sheeran - Perfect","Justin Bieber - Sorry");
question[3] = new Question("../audio/despacito.mp3","Luis Fonsi - Despacito","El Chombo - Dame Tu Cosita","Psy - Gangam Style");
...
question[7] = new Question("../audio/sugar.mp3","Maroon 5 - Sugar","OneRepublic - Counting Stars","Passenger - Let Her Go");
